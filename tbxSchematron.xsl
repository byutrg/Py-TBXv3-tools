...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <rdf:Description xmlns:dct="http://purl.org/dc/terms/"
      ...
      <dct:created>2022-09-12T11:14:00.182-06:00</dct:created>
   </rdf:Description>
   ...
   <xsl:template name="d12e6">
      <schxslt:document>
         <schxslt:pattern id="d12e6">
         ...
         <xsl:apply-templates mode="d12e6" select="/"/>
      </schxslt:document>
   </xsl:template>
   <xsl:template match="tbx:termNote" priority="7" mode="d12e6">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd12e6']">
            <schxslt:rule pattern="d12e6">
         ...
         <xsl:otherwise>
            ...
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
                               as="xs:string*"
                               select="($schxslt:patterns-matched, 'd12e6')"/>
            </xsl:next-match>
         </xsl:otherwise>
      </xsl:choose>
   </xsl:template>
   <xsl:template match="tbx:*[@type]" priority="6" mode="d12e6">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd12e6']">
            <schxslt:rule pattern="d12e6">
   ...
   <xsl:template match="*[@target]" priority="5" mode="d12e6">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd12e6']">
            <schxslt:rule pattern="d12e6">
   ...
   <xsl:template match="tbx:sc[following-sibling::tbx:ec]" priority="4" mode="d12e6">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd12e27']">
            <schxslt:rule pattern="d12e27">
         ...
         <xsl:otherwise>
            ...
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
                               as="xs:string*"
                               select="($schxslt:patterns-matched, 'd12e27')"/>
            </xsl:next-match>
         </xsl:otherwise>
      </xsl:choose>
   </xsl:template>
   <xsl:template match="tbx:ec[preceding-sibling::tbx:sc]" priority="3" mode="d12e6">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd12e27']">
            <schxslt:rule pattern="d12e27">
   ...
   <xsl:template match="tbx:ec[@isolated='yes']" priority="0" mode="d12e6">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd12e27']">
            <schxslt:rule pattern="d12e27">
