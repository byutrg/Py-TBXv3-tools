...
file_text2 = tk.Label(middle2, text="Please Select a file: ")
file_text2.grid(row=0, column=1)
file_select2 = tk.Button(middle2, text="Browse", command=browseFiles)
file_select2.grid(column=2, row=0)

#steamroll = tk.Button(tab2, text="Steamroll!", command=steamroll(file_text.cget("text")))
#steamroll.grid(row=3, column=0, pady=5)
widgets.pack()
window.mainloop()